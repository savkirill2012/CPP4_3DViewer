...
/* Main entry points */
GifFileType *EGifOpenFileName(const char *GifFileName, BOOL GifTestExistence,
                              int *Error);
...
int EGifPutImageDesc(GifFileType *GifFile, int GifLeft, int GifTop,
                     int GifWidth, int GifHeight, BOOL GifInterlace,
                     const ColorMapObject *GifColorMap);
...
extern void GifDrawText8x8(SavedImage *Image, int x, int y, const char *legend,
                           int color);

extern void GifDrawBox(SavedImage *Image, int x, int y, int w, int d,
                       int color);

extern void GifDrawRectangle(SavedImage *Image, int x, int y, int w, int d,
                             int color);

extern void GifDrawBoxedText8x8(SavedImage *Image, int x, int y,
                                const char *legend, int border, int bg, int fg);
